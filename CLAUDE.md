...
7. **Secrets never in code, config defaults, fixtures, or docs.** `NUXT_SESSION_PASSWORD` and service tokens live in worker secrets + the committee password manager. Seed scripts generate random credentials at runtime and print them.
