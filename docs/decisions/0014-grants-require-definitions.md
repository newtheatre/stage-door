...
**Status:** Accepted · **Date:** 2026-08-14 · **Deciders:** Matt Adcock (ITM 26/27), implemented with Claude Code · Partially supersedes [ADR-0004](0004-scoped-role-strings.md) and [ADR-0011](0011-role-definitions-and-expiry.md) (the "no mandatory registry" stance)
