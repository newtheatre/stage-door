...
| [0027](0027-icons-are-bundled-not-fetched.md) | Icons are bundled at build time, never fetched at render time | Accepted: estate-wide, a Worker cannot reach the Iconify API |
