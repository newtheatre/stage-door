...
**Status:** Accepted · **Date:** 2026-08-13 · **Deciders:** Matt Adcock (ITM 26/27), implemented with Claude Code · Closes accepted risk #1 in [security.md](../security.md) · Builds on [ADR-0005](0005-workspace-only-google-sso.md)
