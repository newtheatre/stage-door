...
Future work agreed in principle but not yet scheduled. Each item states the problem, the sketched design, and what it touches: enough that a successor can pick it up without re-deriving the thinking. When an item is picked up, it graduates: ADR for the decision, then specs into the main docs.
